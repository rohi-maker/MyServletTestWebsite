...
<body>
    ...
    <header class="header text-center">	    
	    <h1 class="blog-name pt-lg-4 mb-0"><a href="HomePage.jsp">The Desi Coders</a></h1>
    ...
    <div class="main-wrapper">
	    <section class="cta-section theme-bg-light py-5">
		    <div class="container text-center">
			    <h2 class="heading">Desi Coders - Goal to have coder in every home</h2>
			    <div class="intro">Welcom to "DesiCoders" And sign up for more updates</div>
